  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute left-1/2 top-[-10%] h-[40rem] w-[40rem] -translate-x-1/2 rounded-full bg-linear-to-tr from-fuchsia-500/20 via-purple-500/20 to-indigo-500/20 blur-3xl" />
        <div className="mx-auto h-full w-full bg-[radial-gradient(transparent_1px,rgba(0,0,0,0.02)_1px)] bg-size-[16px_16px]" />
      </div>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-20 pt-16 sm:pt-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight sm:text-6xl">
            The simplest way to{" "}
            <span className="bg-linear-to-r from-indigo-600 via-fuchsia-600 to-pink-600 bg-clip-text text-transparent">
              create forms
            </span>
          </h1>
      ...
      <footer className="mt-20 border-t">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 py-10 sm:flex-row">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Formsmith. Built with ❤️ & open source.
          </p>
